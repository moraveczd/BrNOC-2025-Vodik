...
\frame{
	\frametitle{}
	\vfill
	\textit{Fotokatalytický rozklad vody}
	\begin{itemize}
	...
	\begin{columns}
		...
		\begin{column}{0.7\textwidth}
			\begin{figure}
				\adjincludegraphics[width=0.5\textwidth]{img/CatalysisScheme.png}
...
\frame{
	...
	\begin{itemize}
		...
		\item Fotokatalytický rozklad vody je velmi účinná a zajímavá metoda převodu solární energie na chemickou.\footnote[frame]{Zdroj: \href{https://www.sciencedirect.com/topics/engineering/photocatalytic-hydrogen-production}{Photocatalytic Hydrogen Production}}
	\end{itemize}

	\begin{figure}
		\adjincludegraphics[height=0.4\textheight]{img/cctc201601659-fig-0005-m.jpg}
		\caption*{Fotokatalytický rozklad vody.\footnote[frame]{Zdroj: \href{https://doi.org/10.1002/cctc.201601659}{Wiley}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Problémem jsou malé rozměry molekuly \ce{H2} a tím i její snadné pronikání těsnícími materiály
...
\frame{
	\frametitle{}
	\begin{figure}
		\adjincludegraphics[width=.78\textwidth]{img/Potential_energy_diagram_for_ammonia_synthesis.png}
...
\subsection{Využití vodíku}
\frame{
	\frametitle{}
	\textbf{Využití vodíku}
	\begin{itemize}
		\item Spalování vodíku s kyslíkem je technicky obtížně proveditelné, proto se příliš nevyužívá.\footnote[frame]{\href{https://www.youtube.com/watch?v=NwMQV2koTK0}{Hydrogen burner ignition test}}
		\item \ce{2 H2 + O2 -> H2O}
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Hydrogen_flame.jpg}
		\caption*{Vodíkový plamen.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Hydrogen_flame.jpg}{Pań w żółtym kapeluszu/Commons}}}
	\end{figure}
}
...
\frame{
	\frametitle{}
	\textbf{Palivové články s protonově vodivou membránou}
	\begin{itemize}
		\item PEMFC -- Proton-exchange membrane fuel cell
		\item Na anodě dochází k oxidaci vodíku:
		\item \ce{H2 -> 2 H+ + 2 e-}
		\item Vzniklé ionty \ce{H+} procházejí speciální membránou ke katodě, kde dochází k redukci kyslíku a vzniku vody:
		\item \ce{1/2 O2 + 2 H+ + 2e- -> H2O}
		\item Membrána je zpravidla vyrobena z Nafionu, kopolymeru tvořeného perfluorovaným kopolymerem se sulfonovými skupinami.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.45\textwidth]{img/Nafion3.png}
		\caption*{Nafion.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:Nafion3.svg}{Roland.chem/Commons}}}
	\end{figure}
}
...
\frame{
	...
	\textbf{Palivové články s protonově vodivou membránou}
	\begin{figure}
		\adjincludegraphics[width=1.1\textwidth]{img/MEA_Fabrication_Methods.jpg}
		\caption*{Výroba PEMFC.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:MEA_Fabrication_Methods.jpg}{Xi Yin/Commons}}}
	\end{figure}
}
...
\frame{
	...
	\large
	Zdeněk Moravec\\
	\href{https://is.muni.cz/www/moravec/brnoc/}{is.muni.cz/www/moravec/brnoc/}\\
	hugo@chemi.muni.cz
	\\
	\adjincludegraphics[height=.3\textheight]{img/QR-IS.png}
	\vfill
}
